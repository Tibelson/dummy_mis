...
//
//import com.ug.misweb.security.JwtAuthenticationFilter;
...
//                // Uncomment the lines below to enable proper security:
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .cors(cors -> cors.configurationSource(corsConfig.corsConfigurationSource())) // ✅ Apply your CORS bean
